 ...
 */
@JsonPropertyOrder({
  UpdateDeviceGroupRequest.JSON_PROPERTY_NAME
})
public class UpdateDeviceGroupRequest {
  ...
  public UpdateDeviceGroupRequest name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateDeviceGroupRequest.name);
  }
